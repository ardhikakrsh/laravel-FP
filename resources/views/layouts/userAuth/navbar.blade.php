        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/posts" class="{{ request()->is('posts') ? 'bg-indigo-700' : 'text-white hover:bg-indigo-800 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">About</a>
              <a href="/product" class="{{ request()->is('product') ? 'bg-indigo-700' : 'text-white hover:bg-indigo-800 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">Product</a>
              <a href="/contact" class="{{ request()->is('contact') ? 'bg-indigo-700' : 'text-white hover:bg-indigo-800 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">Contact</a>
              <a href={{ '/review' }} class="text-white hover:bg-indigo-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Review</a></div>
          </div>
        </div>
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            <button type="button" class="relative rounded-full bg-indigo-700 p-1 text-white hover:text-black focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
