...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <h1 class="bg-indigo-700 text-3xl font-semibold text-white pl-4 pt-2 rounded-t-lg">Data Users</h1>
    <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4 bg-indigo-700">
        ...
        <div class="flex justify-end w-full md:w-auto">
            <a href="{{ route('users.create') }}" class="flex items-center px-4 py-2 text-sm font-medium text-white bg-black rounded-lg hover:bg-indigo-600 focus:ring-4 focus:ring-primary-300 focus:outline-none">
