...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    <div class="carousel relative container mx-auto" style="max-width:100%;">
        <div class="rounded-t-lg carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item absolute opacity-0" style="height:61vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('{{ asset('assets/img/slide1.jpg') }}');">
                </div>
            </div>
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-right" style="height:60vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('{{ asset('assets/img/slide3.jpg') }}');">
                </div>
            </div>
            ...
            <div class="carousel-item absolute opacity-0" style="height:60vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-bottom" style="background-image:url('{{ asset('assets/img/slide2.jpg') }}');">
                </div>
            </div>
    ...
    <section class="bg-white py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('assets/img/dunklowgrey.png') }}">
                    ...
                    <p class="pt-1 text-gray-900">Rp1.900.000</p>
                </a>
            </div>

            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('assets/img/dunklowVB.png') }}">
                    <div class="pt-3 flex items-center justify-between">
                    ...
                    <p class="pt-1 text-gray-900">Rp2.200.000</p>
                </a>
            </div>

            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('assets/img/dunklowgeorge.png') }}">
                    <div class="pt-3 flex items-center justify-between">
                    ...
                    <p class="pt-1 text-gray-900">Rp3.300.000</p>
                </a>
            </div>

            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('assets/img/aj1mocha.jpeg') }}">
                    <div class="pt-3 flex items-center justify-between">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('assets/img/hyperpink.png') }}">
                    <div class="pt-3 flex items-center justify-between">
                    ...
                    <p class="pt-1 text-gray-900">Rp2.600.000</p>
                </a>
            </div>

            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('assets/img/kobe5undefeated.png') }}">
                    <div class="pt-3 flex items-center justify-between">
                    ...
                    <p class="pt-1 text-gray-900">Rp5.200.000</p>
                </a>
            </div>

            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('assets/img/kobe8.png') }}">
                    <div class="pt-3 flex items-center justify-between">
                    ...
                    <p class="pt-1 text-gray-900">Rp4.500.000</p>
                </a>
            </div>

            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="{{ asset('assets/img/kobe4philly.png') }}">
                    <div class="pt-3 flex items-center justify-between">
                    ...
                    <p class="pt-1 text-gray-900">Rp3.550.000</p>
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white py-8">
        <div class="container py-10 px-8 mx-auto">
            ...
            About</a>
            <p class="mt-8 mb-8">At Sole City Kicks, we live and breathe sneakers. We’re a one-stop shop dedicated to connecting sneaker enthusiasts with the hottest, 
                most sought-after footwear. Whether you're a seasoned collector or just getting started, we've got something for everyone. 
                Our mission is to provide our customers with an extensive collection of high-quality, authentic sneakers, all in one convenient place. 
                Founded by sneakerheads, for sneakerheads, Sole City Kicks was born out of a love for the culture and the kicks that define it. We understand that sneakers 
                are more than just shoes; they’re a lifestyle, a passion, and an expression of individuality. Our team carefully curates every pair in our collection to ensure 
                it meets the highest standards of quality and authenticity.</p>
            <p class="mt-8 mb-8">We’re committed to delivering the best sneakers and the best service. We work tirelessly 
                to bring you the latest and greatest in sneaker culture, all while providing an unparalleled shopping experience. Thank you for choosing Sole City Kicks. Step into the world of sneakers with us, and find your next pair today!</p>
        </div>
    </section>
